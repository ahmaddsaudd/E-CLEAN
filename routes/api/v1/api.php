...
use App\Http\Controllers\SmartPayController;
...
Route::group(['namespace' => 'Api\V1', 'middleware'=>['localization','react']], function () {
    ...
    Route::group(['prefix' => 'auth', 'namespace' => 'Auth'], function () {
        ...
        Route::post('verify-phone', 'CustomerAuthController@verify_phone'); //phone
        ...
        Route::get('/smartpay/checkout', [SmartPayController::class, 'showCheckoutForm'])->name('smartpay.checkout');
        Route::post('/smartpay/process-payment', [SmartPayController::class, 'processPayment'])->name('smartpay.processPayment');
        Route::post('/smartpay/handle-response', [SmartPayController::class, 'handleResponse'])->name('smartpay.handleResponse');
    ...
    Route::group(['prefix' => 'vendor', 'namespace' => 'Vendor', 'middleware'=>['vendor.api']], function () {
        ...
        Route::post('make-wallet-adjustment', 'VendorController@make_wallet_adjustment')->name('make_wallet_adjustment-vendor');
